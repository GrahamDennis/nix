...

{
  ...
  testScript =
    ...
    ''
      ...
      info2 = json.loads(client.succeed(f"nix flake metadata {info['url']} --json --access-tokens github.com=ghp_000000000000000000000000000000000000 --tarball-ttl 0 --extra-experimental-features no-implicit-final-fetch"))
